...
<div class="container mb-2 mt-4 hstack justify-content-between">
    <h3 class="text-center align-text-bottom">Disposition Table</h3>
    <div class="d-grid gap-2 d-md-flex">
        <a class="btn btn-primary" href="../admin.php">Admin Home</a>
        <a class="btn btn-warning" href="dispositionadd.php">Add New</a>
    ...
    <table
        ...
        <thead>
            <tr>
                ...
                <th scope="col" class="col-11 align-middle" data-sortable="true">Disposition</th>
        ...
        <tbody class="table-group-divider">
            <?php foreach ($dispositions as $disposition) {
                ...
                echo
                "<tr class='brand-row'>
                    <th scope='row' class='text-center align-middle id''>" . $disposition->getId() . "</th>
                    <td class='align-middle name'>" . $disposition->getDescription() . "</td>
...
<div class="modal fade" id="delete" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="deleteLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="column" action="dispositiondelete.php" method="post" name="login">
                <div class="modal-body">
                    <div class="alert alert-danger" role="alert">Are you <strong>sure</strong> you want to delete this disposition?</div>
                    <div class="col-auto">
                        <label for="deleteId" class="col-form-label">ID</label>
                    </div>
                    <div class="col-auto">
                        <input type="text" class="form-control" id="deleteId" name="id" value="<?php echo $disposition->getId(); ?>" readonly>
                    </div>
                    <div class="col-auto">
                        <label for="deleteDisposition" class="col-form-label">Disposition</label>
                    </div>
                    <div class="col-auto">
                        <input type="text" class="form-control" id="deleteDisposition" name="disposition" value="<?php echo $disposition->getDescription(); ?>" readonly>
                    </div>
                </div>
...
<div class="modal fade" id="edit" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="editLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="column" action="dispositionedit.php" method="post" name="dispositionedit">
                <div class="modal-body">
                    <div class="col-auto">
                        <label for="editId" class="col-form-label">ID</label>
                    </div>
                    <div class="col-auto">
                        <input type="text" class="form-control" id="editId" name="id" value="<?php echo $disposition->getId(); ?>" readonly>
                    </div>
                    <div class="col-auto">
                        <label for="editDisposition" class="col-form-label">Disposition</label>
                    </div>
                    <div class="col-auto">
                        <input type="text" class="form-control" id="editDisposition" name="disposition" value="<?php echo $disposition->getDescription(); ?>">
                    </div>
                </div>
                <div class="modal-footer">
