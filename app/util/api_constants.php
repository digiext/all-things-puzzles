...
const PERM_CREATE_USER_INVENTORY = 1 << 11;
const PERM_EDIT_USER_INVENTORY = 1 << 12;
const PERM_DELETE_USER_INVENTORY = 1 << 13;

const PERM_WRITE_USER_INVENTORY = PERM_CREATE_USER_INVENTORY | PERM_EDIT_USER_INVENTORY | PERM_DELETE_USER_INVENTORY;
