...
const PERM_EDIT_PUZZLE = 1 << 3;
const PERM_DELETE_PUZZLE = 1 << 4;
const PERM_WRITE_PUZZLE = PERM_EDIT_PUZZLE | PERM_DELETE_PUZZLE;
const PERM_PUZZLE = PERM_READ_PUZZLE | PERM_WRITE_PUZZLE;
const PERM_READ_WISHLIST = 1 << 5;
const PERM_CREATE_WISHLIST = 1 << 6;
const PERM_EDIT_WISHLIST = 1 << 7;
const PERM_DELETE_WISHLIST = 1 << 8;
...
const PERM_READ_USER_INVENTORY = 1 << 9;
const PERM_ADD_USER_INVENTORY = 1 << 10;
const PERM_EDIT_USER_INVENTORY = 1 << 11;
const PERM_DELETE_USER_INVENTORY = 1 << 12;
const PERM_WRITE_USER_INVENTORY = PERM_ADD_USER_INVENTORY | PERM_EDIT_USER_INVENTORY | PERM_DELETE_USER_INVENTORY;
